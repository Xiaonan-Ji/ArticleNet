...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload=""> 
	...
	if(!isset($_SESSION["dir"])||!isset($_SESSION["tag"])||!isset($_SESSION["recommended"])){
	...
	?>
			...
			<form action="u-feedback.php" method="get">
				<h5>Step3:Set the weight for different factors and initial values...</h5><br/>
				...
				<tr>
					...
					<h8>(You can increase this value if no article can be decided as included or excluded in one round.)</h8></td>
				</tr>
