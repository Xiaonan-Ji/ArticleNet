...
//echo  "<h4>Title Similarity: " . $title . "</br>Abstract Similarity: ".$ab."</br>MeSH Similarity: ".$mh."</br>Author Similarity: " . $author1 . "</br>Keywords: ".$key."</br>Publish Type: ".$type."</br>Author: " . $author2 ."<br>Recommend " . $step . " articles per round."."</h4>";
...
// call recommendation
	//echo 	$step ." ". $step." " . $articlenum . " " .  $dir_base ." 40" . " " . $key . " " . $type . " " . $ab . " " . $mh . " " . $title . " " . $author1 . " " . $author2 . " " . $time1 . " " . $recommended;
