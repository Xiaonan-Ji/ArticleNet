/* This code is revised from Porter Stemmer, 
   it can process a string and return a string with stemmed words.
   Revised by Xiaonan Ji, on 12/11/2012

   The referred Porter stemming algorithm was coded up in ANSI C by the
   Martin Porter. 

   Porter, 1980, An algorithm for suffix stripping, Program, Vol. 14,
   no. 3, pp 130-137,
   Code is from http://www.tartarus.org/~martin/PorterStemmer */
   
#ifndef _STEMMER_H_
#define _STEMMER_H_

/* *********************************************************stem functions******************************************************************* */
// the stemming function starts here
...
void stemfile(struct stemmer * z, char f[], int size, char output[])
{   int j=0;
	//char temp;
